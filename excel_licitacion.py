...
def _build_memoria_calculo_sheet(wb: openpyxl.Workbook, cubicacion: dict,
    ...
    formulas = [
        ...
        ("4.9", "Shotcrete / Malla / Pernos (.10, .11, .12)",
         "Sin cant — depende RMR geotecnico (STM38019 pendiente)",
         0, "—", "⚠ Precios listados, cantidades en blanco"),
    ...
    supuestos = [
        ...
        ("6.7", "Cantidades 4.x.10-12 (shotcrete/malla/pernos)",
         "No cubicado — solo precio UF/u",
         "Requiere RMR/Q rock mass STM38019",
         "Eventual según geotecnia", "⚠ Pendiente RMR"),
