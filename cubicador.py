...
_VIALES = re.compile(
    ...
    r"BAJADA DE AGUA|CONTRACUNETA|BALIZAS|DELINEADOR|HITO KILOMETRICO|IMBORNAL|REJILLA|"
    r"IMPRIMACION|RIEGO DE ADHERENCIA|SUBDREN|HORMIGON CICLOPEO|PERNO DE ROCA|"
    r"OBRA DE ARTE|PAVIMENTO FLEXIBLE)\b"
)
...
_VIAL_CATS = [
    ...
    (re.compile(r"\b(TERRAPLEN|RELLENO COMPACTADO|RELLENO ESTRUCTURAL|RELLENO ZANJAS|RELLENO ZANJA|RELLENO MATERIAL PRESTAMO|EMBANQUE|CORTE Y RELLENO|CAMA DE ARENA|TIERRA DE RELLENO|GRAVA DE NIVELACION)\b"), "terraplen"),
    ...
    (re.compile(r"\b(ENROCADO|ENROCAMIENTO|MURO GAVION|MURO DE PIEDRA|MURO TIERRA ARMADA|MURO DE SOSTENIMIENTO|MURO CICLOPEO|HORMIGON CICLOPEO|PLACA ANCLAJE|PERNO DE ROCA|TALUD REVESTIDO|ESCOLLERA|ZAMPEADO)\b"), "muro"),
    ...
    (re.compile(r"\b(OBRA DE ARTE MENOR)\b"), "alcantarilla"),
]
    ...
    for elem in viales_detectados:
        ...
        if cat == "calzada":
            ...
            es_conservacion = bool(re.search(
                r"\b(RECARPETEO|BACHEO|RIEGO DE LIGA|RIEGO DE ADHERENCIA|IMPRIMACION ASFALTICA|CAPA IMPRIMACION|CONSERVACION|MICROPAVIMENTO|LECHADA ASFALTICA|SELLO DE GRIETAS|SELLO ASFALTICO)\b",
                n_norm,
            ))
