...
_VIALES = re.compile(
    ...
    r"ENSANCHE|SOBREANCHO|RELLENO|EXCAVACION|MEDIANA|TROCHA|ASFALTADO)\b"
)
...
_VIAL_CATS = [
    ...
    (re.compile(r"\b(REVEGETACION|HIDROSIEMBRA|COBERTURA VEGETAL|SIEMBRA TALUD|MEDIANA VERDE|SEPARADOR VEGETAL)\b"), "revegetacion"),
    ...
    (re.compile(r"\b(CALZADA|BERMA|ENSANCHE|SOBREANCHO|VIA RAPIDA|VIA EXPRESA|VIA TRONCAL|VIA COLECTORA|VIA LOCAL|AUTOPISTA|ROTONDA|GLORIETA|ASFALTADO|TROCHA)\b"), "calzada"),
